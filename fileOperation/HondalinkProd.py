...
driver.get("https://hondalink.honda.com/#/")
# driver.save_screenshot('first.png')

driver.find_element_by_xpath("//a[contains(text(),'MY ACCOUNT')]").click()
driver.find_element_by_xpath("//a[@id='register_link']").click()
driver.find_element_by_id("text1").send_keys(value)
driver.find_element_by_id("selectRegion")
driver.find_element_by_xpath("//option[@value='CA']").click()
...
driver.find_element_by_xpath("//span[text()='Refresh']").click()
driver.find_element_by_xpath("//span[text()='Refresh']").click()
wait.until(expected_conditions.presence_of_element_located((By.XPATH, '''//div[text()='"HondaLink" <myhondalinkaccount@email.honda.com>']''')))
driver.find_element_by_xpath('''//div[text()='"HondaLink" <myhondalinkaccount@email.honda.com>']''').click()
...
# driver.get("https://myaccount.acura.com/registration")
driver.get("https://hondalink.honda.com/#/signin")
